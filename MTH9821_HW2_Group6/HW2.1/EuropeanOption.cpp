...
//
// Last Modifications
// 2022.09.05 add EuropeanOption::Put(double z)
...
//std::array<double, 6> EuropeanOption::OptionGreeks(double z) const {
//    // Square root of time
...
std::array<double, 2> EuropeanOption::SpotAndPut(double z) const {
    // Square root of time
    double sqrtT = std::sqrt(T_);
