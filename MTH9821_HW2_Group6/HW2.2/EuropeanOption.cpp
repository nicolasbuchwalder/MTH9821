...
double EuropeanOption::CallFromNormal(double z) const {
    double sqrtT = std::sqrt(T_);                                                           // square root of time
...
double EuropeanOption::PutFromNormal(double z) const {
    double sqrtT = std::sqrt(T_);                                                           // square root of time
...
double EuropeanOption::CallFromStock(double S) const {
    double sqrtT = std::sqrt(T_);                                                           // square root of time
...
double EuropeanOption::PutFromStock(double S) const {
    double sqrtT = std::sqrt(T_);                                                           // square root of time
